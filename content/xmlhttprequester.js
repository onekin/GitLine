function githubdeltas_xmlhttpRequester(unsafeContentWin, chromeWindow) {
...
githubdeltas_xmlhttpRequester.prototype.contentStartRequest = function(details) {
	...
	switch (scheme) {
		...
		case "ftp":
			this.chromeWindow.setTimeout(
				githubdeltas_gmCompiler.hitch(this, "chromeStartRequest", url, details), 0);
			break;
		default:
